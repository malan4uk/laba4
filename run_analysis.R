...
act_labels <- read.csv("E:/Science/STSPS/lab4/Data/activity_labels.txt", header=FALSE, dec=".",sep=" ")
colnames(act_labels) <- c("n", "activity")

test_lines <- readLines(file("E:/Science/STSPS/lab4/Data/test/X_test.txt",open="r"))
train_lines <- readLines(file("E:/Science/STSPS/lab4/Data/train/X_train.txt",open="r"))
data_lines<-c(test_lines,train_lines)

test_act_numb <- readLines(file("E:/Science/STSPS/lab4/Data/test/y_test.txt",open="r"))
train_act_numb <- readLines(file("E:/Science/STSPS/lab4/Data/train/y_train.txt",open="r"))
